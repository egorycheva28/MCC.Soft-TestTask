    ...
    return (
        <div className="container">
            ...
            <div className="instruction">
                <h3>Пояснения</h3>
                <ul>
                    <li>Чтобы просто добавить элемент, нажмите кнопку "Add" и добавьте элемент</li>
                    <li>Чтобы добавить дочерний элемент, выберите родительский элемент, после чего нажмите на кнопку "Add" и добавьте элемент</li>
                    <li>Чтобы удалить элемент, выберите нужный, после чего нажмите кнопку "Remove"</li>
                    <li>Чтобы отредактировать элемент, выберите нужный, после чего нажмите кнопку "Edit" и отредактируйте название</li>
                    <li>Чтобы сбросить все дерево, нажмите кнопку "Reset"</li>
                </ul>
            </div>
        </div>
    );
